<!-- Place this file at: .windsurf/workflows/migrate-x86-to-arm.md -->
# /migrate-x86-to-arm

Description: Migrate a codebase from x86 to Arm using MCP tools, fixing x86-specific dependencies and optimizing for Arm.

1. Review all Dockerfiles and use check_image and/or skopeo to verify Arm compatibility. Update base images if needed.
