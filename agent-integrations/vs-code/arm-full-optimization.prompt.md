...
agent: 'agent'
tools: ['arm-mcp/knowledge_base_search', 'arm-mcp/sysreport_instructions', 'search/codebase', 'edit/editFiles']
---
...
* Establish initial baseline with `Performix MCP run_recipe` and recipe `code_hotspots`.
