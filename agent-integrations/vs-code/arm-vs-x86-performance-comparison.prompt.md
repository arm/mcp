...
description: 'Guide a user through Performix code_hotspots profiling on x86 and Arm hosts, then report architecture-driven performance delta and price-performance signals'
agent: 'agent'
tools: ['arm-mcp/sysreport_instructions', 'arm-mcp/knowledge_base_search', 'search/codebase', 'edit/editFiles']
---
